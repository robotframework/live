...
await loadLibrary('https://robotframework.org/robotframework/latest/libdoc/BuiltIn.json');
await loadLibrary('https://robotframework.org/robotframework/latest/libdoc/Collections.json');
await loadLibrary('https://robotframework.org/robotframework/latest/libdoc/DateTime.json');
await loadLibrary('https://robotframework.org/robotframework/latest/libdoc/String.json');
await loadLibrary('https://robotframework.org/robotframework/latest/libdoc/XML.json');
...
require(['vs/editor/editor.main'], () => {
    ...
    function createSettingsProposals(settingsLines, range) {
        ...
        var proposals = [];
        for (let setting of [...propSettings, ...notSetSettings]) {
